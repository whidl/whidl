...
impl Chip {
            ...
            if signal_sources.contains_key(signal_name) {
                ...
                if idx >= signal_source.len() {
                    return Err(N2VError {
                        ...
                        path: relevant_ident.path.clone(),
    ...
    fn get_port_values_for_direction(&self, direction: PortDirection) -> BusMap {
